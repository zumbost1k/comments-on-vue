<template>
    <div class="comments_item">
      <div class="comment_user_info">
        <img
          :src="
            require(`../photos/photosForProfile/${commentAuthor.pathToPhoto}`)
          "
      ...
      <button
        ...
        type="button"
      >
        <img src="../photos/Reply.svg" alt="reply" width="14" height="13" /><span
          class="reply_text"
          >Reply</span
        >
      </button>
        ...
        <div class="overlay" v-if="showModal">
          <div class="modal">
            ...
            <div class="modal_buttons">
              ...
              <button
                class="modal_btn modal_delete"
                type="button"
                @click="setShowModal(false), deleteComment(comment.id)"
              >
                YES, DELETE
              </button>
            </div>
    ...
    <div class="reply_container">
      <form
        v-if="isReplying"
        @submit.prevent="addAnswerHandler"
        class="answer_form"
      >
        <textarea
          v-model="replyText"
