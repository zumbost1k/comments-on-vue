<template>
  <div class="comments_item">
    ...
    ></textarea>
    <ReferenceCheck v-else :comment-text="textareaValue"></ReferenceCheck>
  ...
  <div class="reply_container">
    ...
    <div v-if="comment.answers && comment.answers.length !== 0">
      <Comment :comment="answer" v-for="answer in comment.answers" :key="answer.id"></Comment>
    </div>
  </div>
</template>
<script>
